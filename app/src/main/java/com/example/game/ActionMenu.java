...
public class ActionMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list[1] = new Situation("Один из городов пострадал от сильного землетрясения. Мы можем помочь жертвам, отправив в регион гуманитарную помощь, или же ограничить расходы, выделив для помощи лишь местные силы.  ","Отправить помощь","Ограничить расходы",-5,-10,15,-5,0,0,5,-5,5,0,-1,-1);
        list[2] = new Situation("В пригородах столицы назревают протесты против беспредела властей. Нужно отправить полицию на подавление протестов. ","Сделаем это","Пожалуй не стоит",-5,0,-10,10,0,5,0,10,0,0,-1,-1);
        list[3] = new Situation("Министр здравоохранения продвигает проект о запрете ввозимых из-за рубежа консервантов под предлогом их некачественности. Стоит ли поддержать её? ","Поддержим","Нам это невыгодно",0,-10,1,0,5,5,10,0,0,-2,-1,-1);
        ...
        list[6] = new Situation("Среди населения начинает распространятся наркотик, распространимый из-а границы. Стоит усилить пограничный досмотр дабы предотвратить его распространение.","Усилить границу","Ничего не делать",0,0,10,-10,10,-5,-10,-10,10,0,-1,-1);
        list[7] = new Situation("Мы нашли новое месторождение нефти. Куда стоит направить прибыль?","В казну","Раздать людям и армии",0,30,0,0,30,0,0,30,10,0,-1,-1);
        list[8] = new Situation("На последней встрече с послом соседней страны было решено заключить торговое соглашение. Однако есть подозрения, что из-за этого местные производители не смогут конкуировать с более дешевой зарубежной продукцией.","Подписать соглашение","Не подписывать",-5,10,-10,0,-10,5,0,-10,0,10,-1,-1);
        list[9] = new Situation("В северных регионах процветает черная археология, что больно бьет по местным памятникам древности. Нам стоит провести масштабный рейд дабы остановить это.","Провести немедленно","Это может подождать",-5,0,10,-10,0,5,0,-20,0,-10,-1,-1);
        ...
        list[11] = new Situation("Министр обороны предлагает провести внеочередные учения на границе вместе с нашими союзниками, дабы припугнуть потенциальных врагов. Однако на это нужны деньги и данное мероприятие может поднять напряжение на международной арене.","Покажем им кузькину мать","Пожалуй, не стоит",-10,-10,10,20,0,5,0,0,-10,0,-1,-1);
        ...
        list[14] = new Situation("Совсем скоро состоится годовщина нашей победы в Великой Войне. Стоит ли проводить парад с полным размахом, как и планировалось, или же выделить дополнительные деньги на помощь ветеранам, а сами торжества провести скромнее?","Помочь ветеранам","Придерживаемся плана",-5,-20,30,10,0,-5,10,-20,10,0,-1,-1);
        list[15] = new Situation("В ваш кабинет заходит секретарша и спрашивает генерала. Кажется, он взял последнюю бутылку импортного вина, предназначавшегося послу соседней страны.","Пусть забирает","Он был у себя",0,-10,-10,10,0,0,0,10,-10,0,-1,-1);
        list[16] = new Situation("Население процветает, а правительству нужны деньги. Стоит поднять налоги.","Удвоить","Поднять немного",0,30,-10,0,10,0,15,10,0,10,-1,-1);
        list[17] = new Situation("Политика церкви набирает популярность среди народа. Стоит ограничить ее власть во избежание дальнейших проблем.","Что они себе позволяют!","Не стоит",-5,0,-15,15,0,5,0,10,-10,0,-1,-1);
        list[18] = new Situation("У лидера нашего альянса военная наука более развита, чем у нас, потому что там разрешены опыты на людях. Нам нужно сделать то же самое!","Мы не безумцы","Прогресс требует жертв",10,0,10,-20,10,-15,-20,-15,15,0,-1,-1);
        ...
        list[21] = new Situation("К вам пришло письмо от жалующихся на произвол власти крестьян. Они просят вас провести проверку одного чиновника, который уже подозревался в коррупции. Однако этим чиновником является ваш старый друг.","Закрыть глаза на это","Немедленно провести проверку",5,-10,-10,0,-5,-5,0,5,0,10,-1,-1);
        list[22] = new Situation("В ходе недавнего урагана была повреждена атомная электростанция и по округе было разбросано радиоактивное ядерное топливо. Что надо делать?","Ограничить область поражения","Немедленно эвакуировать население",-5,-10,0,-10,-10,-5,-10,10,-10,0,-1,-1);
        ...
        list[24] = new Situation("Люди недовольны запретом торговли с другими странами без разрешения правительства. Если мы уберем этот запрет, это может принести в казну больше денег.","Убрать","Ничего не менять",-5,15,10,0,5,5,0,-15,0,-10,-1,-1);
        ...
        list[29] = new Situation("Мы раскрыли сеть накрокартелей, которые прикрывались благотворительными организациями.","Принять меры","Неважно",-5,15,10,-10,5,5,-10,-10,5,-10,-1,-1);
        list[30] = new Situation("Наши ученые сбегают из страны по причине трудных для них условий. Необходимо что-то предпринять дабы остановить утечку кадров в недружественные нам страны.","И немедленно!","Неважно",-5,-10,5,15,5,5,0,-10,-15,-10,-1,-1);
        ...
        list[32] = new Situation("Поступило предложение от одного ученого о финансировании государством школ. Данная мера в перспективе может привлечь больше людей в науку.","Похвальная инициатива","Есть дела поважнее",-5,-10,5,0,10,10,0,-5,-10,-5,-1,-1);
        list[33] = new Situation("Группа исследователей работает над проектом по спасению пригородных районов от новых видом вредителей, однако им не хватает средств.","Выделить деньги","Не сейчас",-5,-10,10,0,5,0,0,-10,0,-5,-1,-1);
        list[34] = new Situation("Устья некоторых крупных рек в стране превратились в болота. Неплохо было бы организовать кампанию по их очистке","Выделить деньги","Это может подождать",-5,-10,10,0,0,0,0,-10,0,-10,-1,-1);
        list[35] = new Situation("Посол соседнего гоусдарства предьявляет ноту протеста в отношении наших действий относительно беженцев из их страны. В случае нашего отказа сотрудничать по этому поводу они грозятся обьявить нам эмбарго, что больно ударить по нашей экономике.  Однако все это очень похоже на политическое оскорбление, так как никаких беженцев в нашу страну не поступало. Как мы отреагируем? ","Подчиниться их требованиям","Еще чего!!",-15,0,-20,-15,0,-15,-15,15,10,-35,-1,-1);
        list[36] = new Situation("На КПП на границе с западной коалицией произошла военная провокация. Есть погибшие. Что мы ответим? ","Огонь на поражение!","Продолжить защиту",0,0,5,10,0,0,0,10,-5,0,-1,-1);
        list[37] = new Situation("Поступили сведения о контрабанде оружием среди солдат. Нужно принять меры.","Начать расследование","Не стоит",-5,10,5,-10,0,5,-10,-10,10,-10,-1,-1);
        list[38] = new Situation("В столице открывается новое здание государственной библиотеки. Стоит ли присутствовать на церемонии открытия?","Всенепременно","Есть дела поважнее",-5,0,10,0,0,5,0,-10,0,0,-1,-1);
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (btn1.getText() == "Стоп...") {
                    ...
                    switch(connection){
                        case (-1):
                            choice_marker = (int) (Math.random() * 39);
                            break;
                        case (15):
                            check = (int) (Math.random() * 101);
                            if(check<20)
                                choice_marker = 245;
                            else
                                choice_marker = 244;
