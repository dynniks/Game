...
public class ActionMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list[9] = new Situation("В северных регионах процветает чёрная археология, что больно бьёт по местным памятникам древности. Нам стоит провести масштабный рейд дабы остановить это.","Провести немедленно","Это может подождать",-5,0,10,-10,0,5,0,-20,0,-10,-1,-1);
        ...
        list[33] = new Situation("Группа исследователей работает над проектом по спасению пригородных районов от новых видов вредителей, однако им не хватает средств.","Выделить деньги","Не сейчас",-5,-10,10,0,5,0,0,-10,0,-5,-1,-1);
        ...
        list[35] = new Situation("Посол соседнего гоусдарства предьявляет ноту протеста в отношении наших действий относительно беженцев из их страны. В случае нашего отказа сотрудничать по этому поводу они грозятся обьявить нам эмбарго, что больно ударит по нашей экономике. Однако все это очень похоже на политическое оскорбление, так как никаких беженцев в нашу страну не поступало. Как мы отреагируем? ","Подчиниться их требованиям","Еще чего!!",-15,0,-20,-15,0,-15,-15,15,10,-35,-1,-1);
